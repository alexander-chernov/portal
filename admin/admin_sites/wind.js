...
function ShowFormAdminSites(i) {
  for(a=1;a<=4;a++) {
    var b = document.getElementById('admin_sites_'+a).style.display = 'none';
  }
  document.getElementById('admin_sites_'+i).style.display = 'block';
}
